...
import com.authorization.sample.awscognitospringauthserver.service.impl.UserServiceImpl;
...
public class AuthController {
    ...
    public ResponseEntity<BaseResponse> resetPassword(@RequestBody @Valid PasswordResetDTO passwordResetDTO) {
        if (!passwordResetDTO.getNewPassword().equals(passwordResetDTO.getConfirmPassword())) {
            return new ResponseEntity<>(new BaseResponse(null, "Passwords do not match", true), HttpStatus.BAD_REQUEST);
        }

        userService.resetUserPassword(passwordResetDTO);
        return new ResponseEntity<>(new BaseResponse(null, "Password reset successfully", false), HttpStatus.OK);
    }
